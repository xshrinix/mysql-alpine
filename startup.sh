...
MYSQL_USER=${MYSQL_USER:-"xtrememedia"}
MYSQL_ROOT_PASSWORD=${MYSQL_ROOT_PASSWORD:-"Admin@1234"}
MYSQL_PASSWORD=${MYSQL_ROOT_PASSWORD:-"Admin@1234"}
MYSQL_DATABASE=${MYSQL_DATABASE:-"signage"}
